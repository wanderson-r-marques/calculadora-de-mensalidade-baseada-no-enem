...
<body class="greey">
    ...
    <script>
        ...
        $(document).delegate('#calcular', 'click', function(event) {
            ...
            const valoresCompletos = [parseInt(red.value), parseInt(lin.value), parseInt(hum.value), parseInt(nat.value), parseInt(mat.value), parseInt(ssa1.value), parseInt(ssa2.value)]
            localStorage.setItem('notas', valoresCompletos)
        ...
        function calculaAjuste(ssa1, ssa2, media) {
            ...
            localStorage.setItem('valorSSA1', valorSSA1)
            const valorSSA2 = 1500 - (10 * ssa2)
            localStorage.setItem('valorSSA2', valorSSA2)
            const valorSSA3 = 1500 - media
            localStorage.setItem('valorSSA3', valorSSA3)
